                    ...
                    <div class="col">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Agregar Vehiculo</h1>
                            </div>
                            <form class="col" action="../../PHP/guardarVehiculo.php" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" 
                                        placeholder="Tipo de vehiculo"  name="tipo" required>
                                </div>
