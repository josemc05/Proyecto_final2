                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">  
                                    ...
                                    <div class="col mr-2">        
                                        <h5 style="color: darkmagenta; font-weight: bold">Reservas Actuales agendadas</h5>      
                                    </div>    
                                    <div class="col-auto"> 
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="logoutModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">¿Desea cancelar esta reservación?</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal" href="reservasActuales.php">no</button>
                    <a class="btn btn-primary" href="#">si</a> <!--PHP-->
                </div>
            </div>
        </div>
    </div>
