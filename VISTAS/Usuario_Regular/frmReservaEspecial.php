                                        ...
                                        <div class="col">
                                            <div class="p-5">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="row no-gutters align-items-center">  
                                                                <img style="height: 19%;width: 19%; padding: -4%; margin: -1.5%;"  src="../../IMG/v1.png">
                                                                <div class="col mr-2">        
                                                                    <h5 style="color: darkmagenta; font-weight: bold; text-align: center;">Reservar Caso especial</h5>      
                                                                </div>    
                                                                <div class="col-auto"> 
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="text-center">
                                                    <h1 class="h4 text-gray-900 mb-4" style="font-size: 15px;">Llene el siguiente formulario de solicitud especial</h1>
                                                </div>
                                                <form class="col">
                                                    ...
                                                    <a href="panelRegular.html" class="btn btn-primary btn-user btn-block">
